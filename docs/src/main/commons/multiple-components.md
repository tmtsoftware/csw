...
:    
```
sbt "sample-deploy/runMain org.tmt.esw.sampledeploy.SampleContainerCmdApp --local src/main/resources/SampleContainer.conf"
```

Java
:    
```
sbt "sample-deploy/runMain org.tmt.esw.sampledeploy.SampleContainerCmdApp --local src/main/resources/JSampleContainer.conf"
```
