...
| [sbt-bintray](https://github.com/sbt/sbt-bintray) | publish | upload and release artifacts into bintray|
| [sbt-native-packager](https://sbt-native-packager.readthedocs.io/en/stable/) | stage | stage your app so you can run it locally without having the app packaged.|       
