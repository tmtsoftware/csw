...
@github[Custom Appender](/csw-logging/csw-logging-client/src/test/scala/csw/logging/client/appenders/CustomAppenderTest.scala)
...
Sourcecode for all the JMH benchmarks can be found here at @github[CSW Benchmarks](/csw-benchmark/src/main) 
...
This graph is produced based on the result generated by @github[JE2ELoggingBenchmark](/csw-benchmark/src/main/java/csw/logging/perf/jmh/JE2ELoggingBenchmark.java) and 
@github[E2ELoggingBenchmark](/csw-benchmark/src/main/scala/csw/logging/perf/jmh/E2ELoggingBenchmark.scala)
