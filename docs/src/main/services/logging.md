...
Sourcecode for all the JMH benchmarks can be found here at [CSW Benchmarks]($github.base_url$/csw-benchmark/src/main) 
...
This graph is produced based on the result generated by [JE2ELoggingBenchmark]($github.base_url$/csw-benchmark/src/main/java/csw/logging/perf/jmh/JE2ELoggingBenchmark.java) and 
[E2ELoggingBenchmark]($github.base_url$/csw-benchmark/src/main/scala/csw/logging/perf/jmh/E2ELoggingBenchmark.scala)
