...
import csw.messages.commands.{CommandInfo, Observe, Setup, Wait}
import csw.messages.events.{EventServiceEvent, SystemEvent}
import csw.messages.models.params.{ObsId, Prefix}
import csw.messages.states.{CurrentState, CurrentStates}
...
class SerializationTest extends FunSuite {
  ...
  test("ConfigType kryo serialization") {
    import csw.messages.generics.ParamSetSerializer._
