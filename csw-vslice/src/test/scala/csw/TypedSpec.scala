...
//  implicit val timeout = Timeout(5.seconds)
  ...
  )(implicit system: ActorSystem[Command]): EventFilter = {
...
object TypedSpec {
  ...
  case class RunTest[T](name: String, behavior: Behavior[T], replyTo: ActorRef[Status], timeout: FiniteDuration)
      extends Command
