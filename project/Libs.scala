...
object Libs {
  ...
  val `junit-4-12`        = "org.scalatestplus"       %% "junit-4-12"        % "3.2.1.0"
  val `testng-6-7`        = "org.scalatestplus"       %% "testng-6-7"        % "3.2.1.0"
...
object Akka {
  val Version = "2.6.8" //all akka is Apache License 2.0
