...
object Libs {
  ...
  val `gson`                         = "com.google.code.gson"                      % "gson"                         % "2.8.8"      //Apache 2.0
  ...
  val `lettuce`           = "io.lettuce"               % "lettuce-core"      % "6.1.3.RELEASE" //6.1.5.RELEASE version is breaking some tests
  val `reactor-core`      = "io.projectreactor"        % "reactor-core"      % "3.4.7"
  val `reactive-streams`  = "org.reactivestreams"      % "reactive-streams"  % "1.0.3"
  val `akka-stream-kafka` = "com.typesafe.akka"       %% "akka-stream-kafka" % "2.1.0"         //2.1.1 version is breaking some tests
  ...
  val `hikaricp`          = "com.zaxxer"                    % "HikariCP"        % "5.0.0" //Apache License 2.0
  ...
  val netty               = "io.netty"                      % "netty-all"       % "4.1.69.Final"
...
object Akka {
  val Version = "2.6.17" //all akka is Apache License 2.0
