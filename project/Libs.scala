...
object Libs {
  ...
  val `reactor-core`      = "io.projectreactor"        % "reactor-core"      % "3.4.5"
  ...
  val `os-lib`            = "com.lihaoyi"                  %% "os-lib"          % "0.7.6"
...
object Akka {
  val Version = "2.6.14" //all akka is Apache License 2.0
