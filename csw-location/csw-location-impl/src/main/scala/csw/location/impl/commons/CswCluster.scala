package csw.location.impl.commons
...
import csw.location.impl.commons.ClusterConfirmationMessages.{HasJoinedCluster, Shutdown}
...
object CswCluster {
   ...
   *
   * @see [[ClusterSettings]] same as [[csw.location.impl.commons.CswCluster.withSettings()]]
