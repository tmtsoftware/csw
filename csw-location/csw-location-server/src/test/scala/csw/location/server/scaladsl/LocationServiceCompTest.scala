...
class LocationServiceCompTest(mode: String)
  ...
  test("should able to register, resolve, list and unregister tcp location| DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-429") {
  ...
  // DEOPSCSW-23: Unregister a comp/service
  // DEOPSCSW-34: Resolve a connection
  test("should able to register, resolve, list and unregister http location | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-429") {
  ...
  // DEOPSCSW-23: Unregister a comp/service
  // DEOPSCSW-34: Resolve a connection
  test("should able to register, resolve, list and unregister akka location | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-429") {
  ...
  List(HCD, Assembly, Sequencer).foreach { compType =>
    test(s"unregistering $compType should unregister both Akka and Http connection | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-429") {
  ...
  test("akka location death watch actor should unregister services whose actorRef is terminated | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-35, DEOPSCSW-36, DEOPSCSW-429") {
    val componentId = models.ComponentId(Prefix(Subsystem.NFIRAOS, "hcd1"), HCD)
    val connection  = AkkaConnection(componentId)
  ...
  // DEOPSCSW-36: Track a crashed service/comp
  test("should able to track tcp connection and get location updated(on registration) and remove(on unregistration) messages | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-26, DEOPSCSW-36, DEOPSCSW-429") {
    val Port               = 1234
  ...
  // DEOPSCSW-12: Create location service API
  test("should be able to subscribe a tcp connection and receive notifications via callback | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-429") {
  ...
  test("should able to track http and akka connection registered before tracking started | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-26, DEOPSCSW-429") {
    val hostname = Networks().hostname
  ...
  // DEOPSCSW-26: Track a connection
  test("should able to stop tracking | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-26, DEOPSCSW-429") {
    val hostname = Networks().hostname
    //create http registration
    val port             = 9595
  ...
  test("should not register a different Registration(connection + port/URI/actorRef) against already registered name | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-18, DEOPSCSW-429") {
  ...
  // DEOPSCSW-23: Unregister a comp/service
  test("unregistering an already unregistered connection does not result in failure | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-429") {
    val connection = TcpConnection(models.ComponentId(Prefix(Subsystem.CSW, "redis4"), ComponentType.Service))
  ...
  // DEOPSCSW-34: Resolve a connection
  test("should able to resolve tcp connection | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-429") {
  ...
  test("should filter components with component type | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-24, DEOPSCSW-429") {
  ...
  test("should filter connections based on Connection type | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-32, DEOPSCSW-429") {
  ...
  test("should filter connections based on hostname | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-31, DEOPSCSW-429") {
  ...
  test("should filter akka connections based on prefix | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-308, DEOPSCSW-429") {
  ...
  // DEOPSCSW-12: Create location service API
  test("should able to unregister all components | DEOPSCSW-12, DEOPSCSW-16, DEOPSCSW-17, DEOPSCSW-20, DEOPSCSW-23, DEOPSCSW-34, DEOPSCSW-429") {
    val Port               = 1234
    val redis1Connection   = TcpConnection(models.ComponentId(Prefix(Subsystem.CSW, "redis1"), ComponentType.Service))
    val redis1Registration = TcpRegistration(redis1Connection, Port)
