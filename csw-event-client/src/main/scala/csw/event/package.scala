 ...
 * 1. [[csw.event.internal.redis.RedisEventService]] - Redis as event store and publisher/subscriber functionality
 * 2. [[csw.event.internal.kafka.KafkaEventService]] - Kafka as event store and publisher/subscriber functionality
 *
 *
