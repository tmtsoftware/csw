...
import csw.logging.core.commons.{Constants, LoggingKeys, TMTDateTimeFormatter}
import csw.logging.core.components.{InnerSourceComponent, SingletonComponent, TromboneAssembly, TromboneHcd}
import csw.logging.core.internal.JsonExtensions.RichJsObject
import csw.logging.core.internal.LoggingLevels._
import csw.logging.core.internal.{LoggingLevels, LoggingState}
...
class SimpleLoggingTest extends LoggingTestSuite {
  ...
  test("should able to log exception at ERROR level with complete stacktrace") {
     ...
     *   "@severity":"ERROR",
     *   "class":"csw.logging.core.scaladsl.TromboneHcd",
