package csw.logging.core.components.iris;
...
public class JIrisSupervisorMutableActor extends AbstractBehavior<LogCommand> {
    ...
    public static <LogCommand> Behavior<LogCommand> irisBeh(String componentName) {
        return Behaviors.setup(ctx -> {
            ...
            return (AbstractBehavior<LogCommand>) new JIrisSupervisorMutableActor((ActorContext<csw.logging.core.LogCommand>) ctx, loggerFactory);
        });
    }
