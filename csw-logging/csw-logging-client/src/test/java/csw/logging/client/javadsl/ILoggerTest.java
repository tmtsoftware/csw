...
//
//    //TODO convert untyped actor to typed
//    private static ActorRef irisSupervisorActor = Adapter.toUntyped(actorSystem).actorOf(Props.create(JIrisSupervisorActor.class), "JIRISActor");
//    private static ActorRef tromboneSupervisorActor = Adapter.toUntyped(actorSystem).actorOf(Props.create(JTromboneHCDSupervisorActor.class, new JLoggerFactory("jTromboneHcdActor")), "JTromboneActor");
//    private static ActorRef genericActor = Adapter.toUntyped(actorSystem).actorOf(Props.create(JGenericActor.class), "JGenericActor");
//
//
//    @BeforeClass
