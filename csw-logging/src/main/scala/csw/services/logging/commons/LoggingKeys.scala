...
private[logging] object LoggingKeys {
  ...
  val CATEGORY       = "@category"        // Set in LogActor. Set to common unless alternative message type passed,
  ...
  val SERVICE        = "@service"         // this appears to be intended for the CSW service name and version.
                                          //   Not used except for custom appender in test.
                                          //   should this be in full header?


  // The following keys are always present
  val TIMESTAMP = "timestamp"             // Logger gets this when contructing Log Message
