...
trait TimeServiceScheduler {
   ...
   * @param f the task to be scheduled for execution
   ...
   *
   * @param duration the time interval between the execution of tasks
   * @param f the task to execute at each interval
   ...
   *
   * @param duration the time interval between the execution of tasks
   * @param runnable the task to execute at each interval
   * @return a handle to cancel execution of further tasks
   */
   ...
   *
   * @param duration the time interval between messages sent to the actor
   ...
   * @param duration the time interval between the execution of tasks
   * @param f the task to execute after each interval
   * @return a handle to cancel execution of further tasks
   */
   ...
   * @param startTime first time at which task is to be executed
   * @param duration the time interval between the execution of tasks
   * @param runnable the task to execute after each interval
