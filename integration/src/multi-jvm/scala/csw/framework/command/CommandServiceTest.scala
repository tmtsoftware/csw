...
class CommandServiceTest(ignore: Int)
  ...
  test("sender of command should receive appropriate responses | DEOPSCSW-207, DEOPSCSW-234, DEOPSCSW-222, DEOPSCSW-228, DEOPSCSW-217, DEOPSCSW-201, DEOPSCSW-212, DEOPSCSW-202, DEOPSCSW-313, DEOPSCSW-623, DEOPSCSW-208, DEOPSCSW-225, DEOPSCSW-224, DEOPSCSW-321") {
