...
docker exec Test-App bash -c 'ifconfig && cd /source/csw && ./integration/target/universal/integration-0.1-SNAPSHOT/bin/test-multiple-nic-app -DakkaSeed=172.17.0.2'
exit_code=$?
