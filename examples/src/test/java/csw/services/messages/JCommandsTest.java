...
public class JCommandsTest {
    ...
    public void showUsageOfSetupCommand() {
        ...
        Setup sc1 = new Setup(obsId, prefixName).add(i1).add(i2);
        ...
        Setup sc3 = new Setup(obsId, prefixName).add(b1).add(b2);
    ...
    public void showUsageOfObserveCommand() {
        ...
        Observe oc1 = new Observe(obsId, prefixName).add(i1).add(i2);
    ...
    public void showUsageOfWaitCommand() {
        ...
        Wait wc1 = new Wait(obsId, prefixName).add(i1).add(i2);
    ...
    public void showJsonSerialization() {
        ...
        //commands
        Setup sc = new Setup(obsId, "wfos.blue.filter").add(i1);
        Observe oc = new Observe(obsId, "wfos.blue.filter").add(i1);
        Wait wc = new Wait(obsId, "wfos.blue.filter").add(i1);
    ...
    public void showUniqueKeyConstraintExample() {
        ...
        Setup setup = new Setup(obsId, prefix).madd(
                encParam1,
                encParam2,
                encParam3,
                filterParam1,
