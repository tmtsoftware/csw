...
public class JResultTest {
    ...
    public void showUsageOfResult() {
        ...
        Result r1 = new Result(runId, obsId, prefix).madd(p1, p2);
        //Create Result using madd
        Result r2 = new Result(runId, obsId, prefix).madd(p1, p2);
        //Create Result and use madd, add
        Result r3 = new Result(runId, obsId, prefix).madd(p1, p2).add(p3);
    ...
    public void showJsonSerialization() {
        ...
        //result
        Result result = new Result(runId, obsId, prefix).add(i1);
    ...
    public void showUniqueKeyConstraintExample() {
        ...
        Result result = new Result(runId, obsId, prefix).madd(
                encParam1,
                encParam2,
                encParam3,
                filterParam1,
