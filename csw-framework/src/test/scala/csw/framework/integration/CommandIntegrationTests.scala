...
class CommandIntegrationTests extends FrameworkIntegrationSuite {
  ...
  private val filterAssemblyConnection = PekkoConnection(models.ComponentId(Prefix(Subsystem.WFOS, "FilterASS"), Assembly))
  private val filterHCDConnection      = PekkoConnection(models.ComponentId(Prefix(Subsystem.WFOS, "FilterHCD"), HCD))
