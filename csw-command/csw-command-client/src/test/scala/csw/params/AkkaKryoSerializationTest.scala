...
//
//      setupSerializer.getClass shouldBe classOf[CommandAkkaSerializer]
//
...
//
//      observeSerializer.getClass shouldBe classOf[CommandAkkaSerializer]
//
...
//
//      waitSerializer.getClass shouldBe classOf[CommandAkkaSerializer]
//
...
//      serialization.findSerializerFor(GoOffline).getClass shouldBe classOf[CommandAkkaSerializer]
//      serialization.findSerializerFor(GoOnline).getClass shouldBe classOf[CommandAkkaSerializer]
//    }

    it("should serialize Lifecycle messages") {
      serialization.findSerializerFor(Lifecycle(GoOffline)).getClass shouldBe classOf[CommandAkkaSerializer]
      serialization.findSerializerFor(Lifecycle(GoOnline)).getClass shouldBe classOf[CommandAkkaSerializer]
    }

    it("should serialize Common messages for all components") {
      serialization.findSerializerFor(Shutdown).getClass shouldBe classOf[CommandAkkaSerializer]
      serialization.findSerializerFor(Restart).getClass shouldBe classOf[CommandAkkaSerializer]
    }
    ...
    it("should serialize Common messages for supervisor") {
      ...
      serialization.findSerializerFor(lifecycleStateSubscription).getClass shouldBe classOf[CommandAkkaSerializer]
      serialization.findSerializerFor(currentStateSubscription).getClass shouldBe classOf[CommandAkkaSerializer]
      serialization.findSerializerFor(supervisorLifecycleStateMessage).getClass shouldBe classOf[CommandAkkaSerializer]
      serialization.findSerializerFor(SupervisorLifecycleState.Idle).getClass shouldBe classOf[CommandAkkaSerializer]
    }
    ...
    it("should serialize Common messages for container") {
      ...
      serialization.findSerializerFor(getComponentsMessage).getClass shouldBe classOf[CommandAkkaSerializer]
      serialization.findSerializerFor(getContainerLifecycleStateMessage).getClass shouldBe classOf[CommandAkkaSerializer]
      serialization.findSerializerFor(components).getClass shouldBe classOf[CommandAkkaSerializer]
      serialization.findSerializerFor(ContainerLifecycleState.Idle).getClass shouldBe classOf[CommandAkkaSerializer]
      serialization.findSerializerFor(ContainerLifecycleState.Running).getClass shouldBe classOf[CommandAkkaSerializer]
    }
  }
}
