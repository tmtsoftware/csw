 ...
 *
 * This class wraps the [[csw.location.model.scaladsl.AkkaLocation]] and provides helpers to send commands to component actor extracted from provided location.
