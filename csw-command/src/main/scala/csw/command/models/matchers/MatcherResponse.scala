...
/**
 * Response generated by [[csw.command.models.matchers.Matcher]]. The response generated could be
 * [[csw.command.models.matchers.MatcherResponses.MatchCompleted]]
 * or [[csw.command.models.matchers.MatcherResponses.MatchFailed]]
 */
