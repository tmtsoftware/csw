...
trait ICommandService {
  ...
  /**
   * Subscribe to all the current states of a component corresponding to the [[csw.location.model.models.AkkaLocation]] of the component
   *
  ...
  /**
   * Subscribe to the current state of a component corresponding to the [[csw.location.model.models.AkkaLocation]] of the component
   *
