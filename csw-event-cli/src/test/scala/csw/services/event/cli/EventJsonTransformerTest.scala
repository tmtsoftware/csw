...
class EventJsonTransformerTest extends FunSuite with Matchers {
  ...
  test("should be able to get top level keys in json") {

    val eventJson         = read[Js.Obj](Source.fromResource("input/event1.json").mkString)
    val expectedEventJson = read[Js.Obj](Source.fromResource("expected/get_path_top_level.json").mkString)
  ...
  test("should be able to get specified paths two levels deep in event in json format") {
    ...
    val eventJson         = read[Js.Obj](Source.fromResource("input/event1.json").mkString)
    val expectedEventJson = read[Js.Obj](Source.fromResource("expected/get_path_2_levels_deep.json").mkString)
  ...
  test("should be able to get multiple specified paths in event in json format") {
    ...
    val eventJson         = read[Js.Obj](Source.fromResource("input/event1.json").mkString)
    val expectedEventJson = read[Js.Obj](Source.fromResource("expected/get_multiple_paths.json").mkString)
  ...
  test("should be able to get specified paths for multiple events in json format") {
    ...
    val event1Json         = read[Js.Obj](Source.fromResource("input/event1.json").mkString)
    val event2Json         = read[Js.Obj](Source.fromResource("input/event2.json").mkString)
    val expectedEvent1Json = read[Js.Obj](Source.fromResource("expected/get_multiple_events1.json").mkString)
    val expectedEvent2Json = read[Js.Obj](Source.fromResource("expected/get_multiple_events2.json").mkString)
