...
class EventJsonTransformerTest extends FunSuite with Matchers with BeforeAndAfterEach {
  ...
  test("should be able to get entire event json when no paths are specified") {
    ...
    val jsonString        = Source.fromResource("get/json/input/event1.json").mkString
  ...
  test("should be able to get top level non struct key from json") {
    ...
    val eventJson            = read[Js.Obj](Source.fromResource("get/json/input/event1.json").mkString)
    val expectedEventJson    = read[Js.Obj](Source.fromResource("get/json/expected/top_level_non_struct_key.json").mkString)
  ...
  test("should be able to get top level partial struct key from json") {
    ...
    val eventJson            = read[Js.Obj](Source.fromResource("get/json/input/event1.json").mkString)
    val expectedEventJson    = read[Js.Obj](Source.fromResource("get/json/expected/top_level_partial_struct_key.json").mkString)
  ...
  test("should be able to get specified paths two levels deep in event in json format") {
    ...
    val eventJson            = read[Js.Obj](Source.fromResource("get/json/input/event1.json").mkString)
    val expectedEventJson    = read[Js.Obj](Source.fromResource("get/json/expected/get_path_2_levels_deep.json").mkString)
  ...
  test("should be able to get multiple specified paths in event in json format") {
    ...
    val eventJson            = read[Js.Obj](Source.fromResource("get/json/input/event1.json").mkString)
    val expectedEventJson    = read[Js.Obj](Source.fromResource("get/json/expected/get_multiple_paths.json").mkString)
  ...
  test("should be able to get specified paths for multiple events in json format") {
    ...
    val event1Json         = read[Js.Obj](Source.fromResource("get/json/input/event1.json").mkString)
    val event2Json         = read[Js.Obj](Source.fromResource("get/json/input/event2.json").mkString)
    val expectedEvent1Json = read[Js.Obj](Source.fromResource("get/json/expected/get_multiple_events1.json").mkString)
    val expectedEvent2Json = read[Js.Obj](Source.fromResource("get/json/expected/get_multiple_events2.json").mkString)
