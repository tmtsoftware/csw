 ...
 */
final class FrameworkTestKitJunitResource(val frameworkTestKit: FrameworkTestKit, services: java.util.List[Service])
   ...
   * */
  def this(services: java.util.List[Service]) = this(FrameworkTestKit(), services)
