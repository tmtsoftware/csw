...
class JsonContractTest extends AnyFunSpec with Matchers {
  ...
  describe("Test Sequence Commands") {
    ...
    it("should adhere to specified standard Setup json format | DEOPSCSW-183, DEOPSCSW-188, DEOPSCSW-282, DEOPSCSW-184, DEOPSCSW-423, DEOPSCSW-401") {
    ...
    it("should adhere to specified standard Observe json format | DEOPSCSW-183, DEOPSCSW-188, DEOPSCSW-282, DEOPSCSW-184, DEOPSCSW-423, DEOPSCSW-401") {
    ...
    it("should adhere to specified standard Wait json format | DEOPSCSW-183, DEOPSCSW-188, DEOPSCSW-282, DEOPSCSW-184, DEOPSCSW-423, DEOPSCSW-401") {
  ...
  describe("Test Events") {
    ...
    it("should adhere to specified standard ObserveEvent json format | DEOPSCSW-183, DEOPSCSW-188, DEOPSCSW-282, DEOPSCSW-184, DEOPSCSW-423, DEOPSCSW-401") {
    ...
    it("should adhere to specified standard SystemEvent json format | DEOPSCSW-183, DEOPSCSW-188, DEOPSCSW-282, DEOPSCSW-184, DEOPSCSW-423, DEOPSCSW-401") {
  ...
  describe("Test State Variables") {
    ...
    it("should adhere to specified standard CurrentState json format | DEOPSCSW-183, DEOPSCSW-188, DEOPSCSW-282, DEOPSCSW-184, DEOPSCSW-423, DEOPSCSW-401") {
    ...
    it("should adhere to specified standard DemandState json format | DEOPSCSW-183, DEOPSCSW-188, DEOPSCSW-282, DEOPSCSW-184, DEOPSCSW-423, DEOPSCSW-401") {
      val charKey    = KeyType.CharKey.make("charKey")
  ...
  describe("Exercise all types of keys") {
    it("should able to serialize and deserialize Setup command with all keys to and from json | DEOPSCSW-183, DEOPSCSW-188, DEOPSCSW-282, DEOPSCSW-184, DEOPSCSW-423, DEOPSCSW-401, DEOPSCSW-661") {
