...
//        var pmjs = JavaJsonSupport.writes(pm, ProperMotion.pmFormat());
//
...
//        var f1 = ICRS();
//        var j1 = JavaJsonSupport.writes(f1, Coords.eqfFormat());
...
//        var js = JavaJsonSupport.writes(c0, JAltAzCoord.coordFormat());
...
//
//        var js = JavaJsonSupport.writes(c0, JSolarSystemCoord.coordFormat());
...
//
//        var js = JavaJsonSupport.writes(c0, JMinorPlanetCoord.coordFormat());
...
//
//        var js = JavaJsonSupport.writes(c0, JCometCoord.coordFormat());
//        var c1 = js.as(JCometCoord.coordFormat());
//        assertEquals(c0, c1);
//
//        var js2 = JavaJsonSupport.writes(c0, JCoord.jsonFormat());
...
//
//        var js = JavaJsonSupport.writes(eq, JEqCoord.coordFormat());
